...
import { renderAgencyDigestText, sendAgencyChatDigest } from '../notifications/agencyChatDigest.js';

test('renderAgencyDigestText surfaces KPIs and per-client criticals', () => {
  const cc = { kpis: { clients_at_risk: 2, approvals_waiting: 5, changes_24h: 9 },
    discoveries: [
