...
| F7 | Search Console connector (GSC depth) | `2026-06-28-f7-search-console-connector.md` | **in_review** | PR #18 branch `feat/ops-f7-search-console-connector` | Promote the single GSC check to a connector. 7 tasks. Keeps web.gsc.* via 20-line shim. RECONCILE on build: F7 adds dedicated `ops_gsc_site_inventory`; confirm vs F1 generic `ops_platform_inventory` — prefer generic unless match-confidence truly needs its own table. |
