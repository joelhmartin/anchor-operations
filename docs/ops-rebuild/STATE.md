...
| F5 | Google Chat cockpit | `2026-06-28-f5-google-chat-cockpit.md` | **in_review** | PR #16 / `feat/ops-f5-google-chat-cockpit` | Webhook digests → interactive app. 9 tasks (P1 webhooks 1–4, P2 interactive 5–9). 63 new tests; 329/330 suite pass (1 pre-existing scheduleFanoutBulk env flake). |
