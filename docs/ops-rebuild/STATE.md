...
| F1 | Connection / capability / asset model | `2026-06-28-f1-connection-model.md` | **in_review** | `feat/ops-f1-connection-model` / PR #12 | 8 tasks built. 40 new F1 tests pass (119/133 total; 14 pre-existing failures in ops_skills/users/client_profiles schema — unchanged from before F1). db-untested: none — all DB tests ran against ephemeral Postgres. |
