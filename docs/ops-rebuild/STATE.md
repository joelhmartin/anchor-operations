...
| F3 | Snapshots + baselines + memory | `2026-06-28-f3-snapshots-baselines-memory.md` | **in_review** | PR #14, branch `feat/ops-f3-snapshots-baselines-memory` | The "knows normal" learning loop. 10 tasks. F4-recommendations memory seam documented. |
