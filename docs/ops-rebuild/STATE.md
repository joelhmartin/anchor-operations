...
| F8 | Client agent profiles | `2026-06-28-f8-client-agent-profiles.md` | **in_review** | branch `feat/ops-f8-client-agent-profiles` / PR #19 | Goals / target CPA / budgets / policies. 5 tasks. |
